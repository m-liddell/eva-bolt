...
import { TERMS } from '../src/store/termStore';
...
export default function Home() {
  ...
  const getInteractiveLessonRoute = (lesson: Lesson): string => {
    ...
    return getGeneralInteractiveRoute(lesson);
  };

  // Function to get routes for general interactive activities
  const getGeneralInteractiveRoute = (lesson: Lesson) => {
    if (!lesson.activities?.starter) return '/teach/lesson';
    
    const activityTitle = lesson.activities.starter.title.toLowerCase();
